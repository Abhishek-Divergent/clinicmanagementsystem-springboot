...
<body>
      ...
      <div class="row">
          <div class="col mt-1">
            ...
            <div class="d-inline pt-1">
                <a class="nav-link text-white btn-dark btn-outline-success" href="adminpage" role="button" >ADMIN LOGIN </a>
            </div>
            <div class="d-inline pt-1 ">
                <a class="nav-link bg-dark disabled " href="doctorpage" role="button">DOCTOR LOGIN </a>
            </div>
        </nav>
          </div>
      </div>
      ...
      <div class="row pt-3">
        <div class="col"><h1 style="text-align: center;">DOCTOR LOGIN</h1></div> 
      ...
      <div class="row pt-4 ">
          ...
          <div class="col">  
           ...
           <div >
               <label for="UserName" class="form-label">Doctor UserName</label>
               <input type="email" class="form-control" name="username" id="UserName" placeholder="Enter Doctor UserName">
            </div>
            <div >
                <label for="Password" class="form-label">Doctor Password</label>
                <input type="password" class="form-control" name="password" id="Password" placeholder="Enter Doctor Password">
             </div>
